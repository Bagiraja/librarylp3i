    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebarrr ms-5 mt-4">
            ...
            <a href="{{ route('admin.users') }}" class="{{ request()->routeIs('admin.users') ? 'active' : '' }}">
                <img src="{{ asset('images/user (3).png') }}" alt="">Manajemen Anggota
            </a>
            <a href="{{ route('admin.rak') }}" class="{{ request()->routeIs('admin.rak') ? 'active' : '' }}">
                <img src="{{  asset('images/computer.png') }}" alt="">Rak
            </a>
            <a href="{{ route('admin.book') }}" class="{{ request()->routeIs('admin.book') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.category') }}" class="{{ request()->routeIs('admin.category') ? 'active' : '' }}">
                <img src="{{ asset('images/books-stack-of-three.png') }}" alt="">Kategori Buku
            </a>
