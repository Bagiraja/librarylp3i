...
@section('content')
    ...
    <div class="container-fluid mt-4">
        <h5 class="mb-4 text-white">Manajemen Denda</h5>
        ...
        <div class="card fine-card">
            <div class="card-header fine-header text-dark" style="background-color: #00328E; border: 2px solid white;">
                <h5 class="mb-0 text-white">Denda Kerusakan</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @forelse($lostFines as $index => $fine)
                                <tr>
                                    ...
                                    <td>
                                        @if (!$fine->is_paid)
                                            <button onclick="markAsPaid({{ $fine->id }})"
    ...
    <!-- Broken Fines Card -->
    <!-- ... kode card denda kerusakan sama seperti sebelumnya ... -->

    <!-- Lost Fines Card -->
    <!-- ... kode card denda kehilangan sama seperti sebelumnya ... -->
    </div>
        ...
        function markAsPaid(fineId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(`/pustakawan/fines/mark-as-paid/${fineId}`, {
                            method: 'POST',
                            headers: {
