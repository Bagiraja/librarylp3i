...
<script>
    function approveRequest(requestId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`/pustakawan/peminjaman/approve/${requestId}`, {
                    method: 'POST',
                    headers: {
    ...
    function disapproveRequest(requestId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`/pustakawan/peminjaman/dissapprove/${requestId}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        'Content-Type': 'application/json'
    ...
    function returnBook(borrowId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`/pustakawan/peminjaman/returnn/${borrowId}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        'Content-Type': 'application/json'
    ...
    function markAsBroken(borrowId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`/pustakawan/peminjaman/broken/${borrowId}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        'Content-Type': 'application/json'
    ...
    function markAsLost(borrowId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`/pustakawan/peminjaman/lost/${borrowId}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        'Content-Type': 'application/json'
