...
<style>
  body{
    ...
    <div class="container">
      ...
      <div class="card">
        <div class="card-body">
          <form action="{{ route('pustakawan.book.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <button type="submit" class="btn mt-2" style="background-color: #00328E; color: white;">Simpan Buku</button>
        </form>
        </div>
      </div>
    </div>
